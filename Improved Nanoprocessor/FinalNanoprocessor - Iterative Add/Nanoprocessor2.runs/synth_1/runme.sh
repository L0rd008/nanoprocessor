...
HD_PWD='L:/Documents/Xilinx/to submit/Improved Nanoprocessor/FinalNanoprocessor - Iterative Add/Nanoprocessor2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nanoprocessor2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nanoprocessor2.tcl
