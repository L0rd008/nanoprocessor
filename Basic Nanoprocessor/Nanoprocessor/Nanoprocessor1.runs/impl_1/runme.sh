...
HD_PWD='L:/Documents/Xilinx/to submit/Basic Nanoprocessor/Nanoprocessor/Nanoprocessor1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nanoprocessor1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nanoprocessor1.tcl -notrace
