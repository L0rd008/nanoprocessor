...
HD_PWD='L:/Documents/Xilinx/to submit/Basic Nanoprocessor/Nanoprocessor/Nanoprocessor1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nanoprocessor1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nanoprocessor1.tcl
